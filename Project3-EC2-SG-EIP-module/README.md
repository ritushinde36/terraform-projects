...
# 🚀 Terraform - EC2, SG, EIP Module

### 📌 Overview

This project provisions AWS infrastructure using Terraform.
It leverages custom modules for VPC, EC2, Security Groups, and EIP to create a scalable and reusable environment.
...
- Security Group Module → Manages ingress/egress rules for Bastion and private instances

- EC2 Module → Launches EC2 instances and bastion hosts in the configured VPC & subnets

- EIP Module → Associates Elastic IPs with EC2 instances

- User Data Support → Bootstraps instances on startup
...
│       └── output.tf                   # Outputs (VPC ID, subnet IDs, etc.)
│
...
└── Project3-EC2-SG-EIP.png             # Architecture diagram
...
![image info](./Project3-EC2-SG-EIP.png)
